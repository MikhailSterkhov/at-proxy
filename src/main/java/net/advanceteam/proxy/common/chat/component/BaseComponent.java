package net.advanceteam.proxy.common.chat.component;

import lombok.*;
import net.advanceteam.proxy.common.chat.ChatColor;
import net.advanceteam.proxy.common.chat.event.ClickEvent;
import net.advanceteam.proxy.common.chat.event.HoverEvent;
